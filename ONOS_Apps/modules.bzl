...
APP_JAR_MAP = {
    ...
    # "//apps/nifwd:onos-apps-nifwd": [],
    "//apps/nifwd_combined/app:onos-apps-nifwd_combined-app": [],
    "//apps/ifwd:onos-apps-ifwd": [],
    # -- NETVIEWS ---
...
APP_MAP = {
    ...
    # -- NETVIEWS ---
#    "//apps/np:onos-apps-np-oar": [],
#    "//apps/nifwd:onos-apps-nifwd-oar": [],
    "//apps/nifwd_combined:onos-apps-nifwd_combined-oar": [],
